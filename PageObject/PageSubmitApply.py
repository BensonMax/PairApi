...
class SubmitApply:
    ...
    def request(self, item):
        ...
        param["applyItemList"] = [{"itemID": "1111", "objectData": "123", "objectID": "0111", "objectType": "user123"},
                                  {"itemID": "2", "objectData": "456", "objectID": "1", "objectType": "user456"}]
        param["apprStepList"] = [{"approver": 1100, "resID": "settle.menu.settle.generatesettle.verify"}]
